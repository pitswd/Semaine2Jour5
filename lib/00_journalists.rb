...
puts '_' * 50
puts 'J O U R N A L I S M E'

#1
puts '_' * 10
puts "Il y a #{journalists.length} journalistes dans cette liste."

#2
puts '_' * 10
puts "Il y a #{journalists.count {|journalist| journalist =~ /[0-9]/ }} handles contenant des chiffres."

#3
puts '_' * 10
puts "Il y a #{journalists.count {|journalist| journalist =~ /aude/ }} handles contenant ``aude``."

#4
puts '_' * 10
puts "Il y a #{journalists.count {|journalist| journalist =~ /@[[:upper:]]/}} handles commençant par une Majuscule."

#5
puts '_' * 10
puts "Il y a #{journalists.count {|journalist| journalist =~ /[[:upper:]]/}} handles contenant une Majuscule."

#6
puts '_' * 10
puts "Il y a #{journalists.count {|journalist| journalist =~ /_/}} handles contenant un underscore."
